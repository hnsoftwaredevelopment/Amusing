...
public class LoggingService
{
    ...
    public async Task WriteUserActionStageTypeAsync( string _stageType, string _area, string _action, string _status, string _report )
    {
        if ( _report == "" )
        {
            return;
        ...
        try
        {
            await _dataService.ExecuteNonQueryAsync( QueryDefinitions.LogStageTypeActions, parameters );
        }
        catch ( Exception ex )
        {
            Dictionary<string, object> err_parameters = new()
    ...
    public async Task WriteUserActionTaskAsync( uint _taskId, string _area, string _action, string _status, string _report )
    {
        if ( _report == "" )
        {
            return;
        ...
        try
        {
            await _dataService.ExecuteNonQueryAsync( QueryDefinitions.LogTaskActions, parameters );
        }
        catch ( Exception ex )
        {
            Dictionary<string, object> err_parameters = new()
